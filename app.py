...
encoder = joblib.load('Machine Learning/Clusterização/enconder.pkl')
scaler = joblib.load('Machine Learning/Clusterização/scaler.pkl')
kmeans = joblib.load('Machine Learning/Clusterização/modelo_kmeans.pkl')
